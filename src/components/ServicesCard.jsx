...
export default function ServicesCard({ title, content, icon }) {
  ...
  return (
    <div className="max-w-[80%] max-h-[50%] shrink-0 px-3 lg:px-8 py-4 lg:py-8 rounded-md shadow border border-1 space-y-4">
      ...
      <p className="text-xs lg:text-[10px]">{boldedContent}</p>
    </div>
  );
}
