      ...
      <div className="flex justify-between font-semibold tracking-wide">
        <div className="leading-9">
          ...
          <div className="flex space-x-2">
            <img className="w-8" src="./assets/mail-icon.svg" />
            <span>info@desirehealthinclusive.com</span>
          </div>
          <div className="flex space-x-2">
            <img className="w-8" src="./assets/phone-icon.svg" />
            <span>+234&nbsp;81&nbsp;5075&nbsp;2548</span>
          </div>
